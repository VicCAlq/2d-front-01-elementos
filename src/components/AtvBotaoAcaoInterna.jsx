...
que não recebe nenhum argumento. Este componente deve exibir uma <div> 
com dois elementos: um <p> com o texto "Clique abaixo", e um <button> 
...
export default function AtvBotaoAcaoInterna()  {
  return(<div>
      <p>Clique abaixo</p>
        <button onClick= {() => alert("Fui clicado!")}>Clique aqui</button>
            </div>)
            }